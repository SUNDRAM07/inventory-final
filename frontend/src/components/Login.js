    ...
    <div className="login-container">
      ...
      <div className="login-card">
        <div className="card-header">
          ...
          <h2 className="form-title">{isLogin ? 'Welcome Back!' : 'Join Us!'}</h2>
          <p className="form-subtitle">
            {isLogin ? 'Sign in to access your inventory dashboard' : 'Create your account to get started'}
          </p>
        </div>
        ...
        {!isLogin && (
          <div className="registration-info">
            <div className="info-card">
              ...
              <p className="info-note">New accounts are created with basic user permissions.</p>
            </div>
          </div>
        )}
      </div>
